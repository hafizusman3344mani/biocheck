...
class CVPSelectSportType extends StatefulWidget {
  @override
  _CVPSelectSportTypeState createState() => _CVPSelectSportTypeState();
}

class _CVPSelectSportTypeState extends State<CVPSelectSportType> {
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  getItem(
                      GlobalResources.cvpvakPath, S.of(context).CVPOPTBicycles),
                  getItem(
                      GlobalResources.cvpwakPath, S.of(context).CVPOPTRunning),
          ...
          Navigator.of(context).pushReplacement(
            RoutePage(
              builder: (BuildContext context) =>
                  MeasurementOptions(Constants.CRONIC_PROTOCOL),
            ),
          );
        });
      },
