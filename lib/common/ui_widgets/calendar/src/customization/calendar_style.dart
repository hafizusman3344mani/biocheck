...
class CalendarStyle {
  ...
  final BoxDecoration contentDecorationSelected;
  ...
  const CalendarStyle({
    ...
    this.contentDecorationSelected = const BoxDecoration(
        color: Colors.redAccent
    ),
    this.weekdayStyle = const TextStyle(fontSize: 13.0,fontWeight: FontWeight.w600),
    this.weekendStyle = const TextStyle(color: AppColors.calenderDateTextColor,fontSize: 13.0,fontWeight: FontWeight.w600), // Material red[500]
    this.holidayStyle = const TextStyle(color: AppColors.calenderDateTextColor,fontSize: 13.0,fontWeight: FontWeight.w600), // Material red[500]
    this.selectedStyle = const TextStyle(color: const Color(0xFFFAFAFA), fontSize: 16.0), // Material grey[50]
    this.todayStyle = const TextStyle(color: AppColors.calenderDateTextColor, fontSize: 13.0,fontWeight: FontWeight.w600), // Material grey[50]
    ...
    this.eventDayStyle = const TextStyle(color: AppColors.calenderDateTextColor,fontSize: 13.0,fontWeight: FontWeight.w600),
    this.selectedColor = const Color(0xFF5C6BC0), // Material indigo[400]
    this.todayColor = AppColors.calenderDateTextColor, // Material indigo[200]
    this.markersColor = const Color(0xFF263238), // Material blueGrey[900]
    this.markersAlignment = Alignment.bottomCenter,
    this.markersPositionTop,
    this.markersPositionBottom = 0.0,
