...
class DaysOfWeekStyle {
  ...
  const DaysOfWeekStyle({
    ...
    this.weekdayStyle = const TextStyle(color: const Color(0xFFBFBFBF),fontSize: 15.0), // Material grey[700]
    this.weekendStyle = const TextStyle(color: const Color(0xFFBFBFBF),fontSize: 15.0), // Material red[500]
  });
}
