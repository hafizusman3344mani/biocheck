...
class _TableCalendarState extends State<TableCalendar>
  ...
  Widget _buildTable() {
    ...
    while (x < widget.calendarController._visibleDays.value.length) {
      List<DateTime> days = widget.calendarController._visibleDays.value
          .skip(x)
          .take(daysInWeek)
          .toList();
      children.add(days.contains(widget.initialSelectedDay)
          ? _buildTableRow(days)
          : _buildTableRow(days));
      x += daysInWeek;
    }
    ...
    return Container(
      ...
      height: AppValue.screenHeight(context) / 1.9,
    ...
    return Container(
      ...
      child: Row(
        ...
        children:
          ...
          var weekdayFirstLetterArr = weekdayString[0];
          final isWeekend =
          ...
          if (isWeekend && widget.builders.dowWeekendBuilder != null) {
            return widget.builders
                .dowWeekendBuilder(context, weekdayFirstLetterArr);
          }
          if (widget.builders.dowWeekdayBuilder != null) {
            return widget.builders
                .dowWeekdayBuilder(context, weekdayFirstLetterArr);
          }
          return Flexible(
            flex: 1,
            child: Container(
  ...
  Widget _buildTableRow(List<DateTime> days) {
    return Container(
      height: 50.0,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          children: [
            Align(
              ...
              child: Pinned.fromSize(
                bounds: Rect.fromLTWH(232.7, 0.0, 33.0, 314.0),
                size: Size(235.0, 95.3),
                pinRight: true,
                fixedWidth: false,
                fixedHeight: false,
                child: Transform.rotate(
                  angle: 1.5708,
                  child: Container(
                    transform: Matrix4.translationValues(-57.0, -50.0, 0.0),
                    decoration: BoxDecoration(
            ...
            Align(
              alignment: Alignment.center,
              child: Pinned.fromSize(
                bounds: Rect.fromLTWH(227.0, -70.0, 40.0, 310.0),
                size: Size(235.0, 95.3),
                pinRight: true,
                fixedWidth: false,
                fixedHeight: false,
            ...
            Align(
              alignment: Alignment.center,
              child: Pinned.fromSize(
                bounds: Rect.fromLTWH(232.7, -110.0, 33.0, 314.0),
                size: Size(235.0, 95.3),
                pinRight: true,
                fixedWidth: false,
                fixedHeight: false,
            ...
            Align(
              alignment: Alignment.center,
              child: Pinned.fromSize(
                bounds: Rect.fromLTWH(227.0, -90.0, 40.0, 310.0),
                size: Size(235.0, 95.3),
                pinRight: true,
                fixedWidth: false,
                fixedHeight: false,
                child: Transform.rotate(
                  angle: -0.0,
                  child: Container(
                    transform: Matrix4.translationValues(-40.0, -90.0, 0.0),
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        begin: Alignment(0.0, -1.0),
                        end: Alignment(0.0, 1.0),
          ...
          child: Stack(
            children: [
              CellWidget(
                ...
                selectedtext: '${DateFormat.E(widget.locale).format(date)}',
    ...
    return Column(
      ...
      children: [
        Container(
          width: 15.0,
          height: 4.0,
          margin: EdgeInsets.symmetric(horizontal: 0.3, vertical: 5.0),
          decoration: BoxDecoration(
