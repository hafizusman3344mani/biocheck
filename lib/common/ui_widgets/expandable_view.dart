  ...
  Widget build(BuildContext context) {
    ...
    Widget buildHeaderRow() {
      ...
      Widget wrapWithExpandableButton({Widget widget, bool wrap}) {
        return wrap ? ExpandableButton(child: widget,srNo:srNo) : widget;
      }
      ...
      if (!theme.hasIcon) {
        ...
        final rowChildren = <Widget>[
          ...
          Textview2(title: srNo,fontWeight: FontWeight.w300,fontSize: 20.0,)
          // ignore: deprecated_member_use_from_same_package
...
class ExpandableButton extends StatelessWidget {
  ...
  ExpandableButton({@required this.child,this.srNo});
